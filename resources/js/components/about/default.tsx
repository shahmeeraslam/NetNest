...
const companyValues: CompanyValue[] = [
    {
        ...
        testimonial: {
            quote: 'Working in an environment that truly values innovation isn&apos;t just about having the latest technology—it&apos;s about feeling empowered to question, experiment, and sometimes fail. This culture has allowed us to develop solutions no one else has thought of yet.',
            author: 'Alex Chen',
    ...
    },
    {
        ...
        testimonial: {
            quote: 'In my ten years with the company, I&apos;ve seen us turn down lucrative opportunities that didn&apos;t align with our ethical standards. That consistent commitment to integrity isn&apos;t just good ethics—it&apos;s built an unparalleled level of trust with our customers.',
    ...
    },
    {
        ...
        testimonial: {
            quote: 'The collaborative spirit here isn&apos;t just talk—it&apos;s built into how we work. Even as we&apos;ve grown to multiple offices globally, we&apos;ve maintained a culture where everyone&apos;s input is valued and people genuinely enjoy working together to solve challenging problems.',
    ...
    },
    {
        ...
        testimonial: {
            quote: 'I&apos;ve been amazed at how customer feedback directly shapes our product roadmap. When I joined, I expected the usual lip service to customer-centricity, but here, customer success genuinely drives every decision from product features to support policies.',
            author: 'Avery Wilson',
    ...
    },
    {
        ...
        testimonial: {
            quote: 'The most inspiring thing about working here is how everyone strives for excellence while remaining humble. There&apos;s always a sense that we can do better—not from a place of dissatisfaction, but from genuine passion for creating the best possible experience for our users.',
    ...
    },
    {
        ...
        testimonial: {
            quote: 'When we announced our carbon-neutral initiative, I wasn&apos;t sure if it would be more than a marketing exercise. Three years later, we&apos;ve reduced emissions by 68%, switched to renewable energy, and built sustainability requirements into our entire supply chain. It&apos;s real change.',
            author: 'Priya Patel',
        ...
        <section className="py-24">
            <div className="container mx-auto px-4 md:px-6 2xl:max-w-[1400px]">
                <div className="mx-auto mb-16 max-w-3xl space-y-4 text-center">
                    <div className="inline-block rounded-lg bg-primary/10 px-3 py-1 text-sm text-primary">Core Values</div>
                ...
                <Tabs value={activeValue} onValueChange={setActiveValue} className="space-y-8">
                        ...
                        <TabsList className="hidden h-auto bg-transparent p-1 md:flex">
                            {companyValues.map((value) => (
                                <TabsTrigger
                                    ...
                                    value={value.id}
                                    className={cn(
                                        'gap-2 data-[state=active]:bg-muted',
                    ...
                    <div className="grid items-center gap-8 md:grid-cols-12">
                        ...
                        <div className="space-y-6 md:col-span-6">
                            ...
                            <p className="text-lg text-muted-foreground">{currentValue.description}</p>
                            ...
                            {currentValue.testimonial && (
                                <Card className="mt-6 bg-muted/30 p-0">
                                    <CardContent className="p-6">
                                        <div className="mb-4 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-muted-foreground">{currentValue.testimonial.role}</p>
                                            </div>
                                        </div>
                            ...
                            {currentValue.image ? (
                                <div className="relative aspect-[4/3] overflow-hidden rounded-xl shadow-lg">
                                    ...
                                    <div className="absolute right-0 bottom-0 left-0 p-6">
                                        <div className={cn('inline-block rounded-lg px-3 py-1 text-sm text-white', 'bg-black/30 backdrop-blur-sm')}>
                                            {currentValue.name}
                                        </div>
                                    </div>
                                </div>
